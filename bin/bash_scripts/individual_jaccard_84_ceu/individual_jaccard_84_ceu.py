...
for person in shared_individuals:
    for algorithm_name in algorithms:
        ...
        for i in range(int(num_shuffles)):
            ...
            # sort
            os.system(f"sort -k1,1 -k2,2n {scratch_dir}/{algorithm_name}_Shuffled_{person}_{i}.bg -o {scratch_dir}/{algorithm_name}_Shuffled_{person}_{i}.bg")
...
for person in shared_individuals:
    ...
    for i in range(num_shuffles):
        ...
        algorithms= list(algorithms_str.split(' '))
